...
def ventana_inicio():
    ...
    ventana_principal.geometry("150x150")
    ventana_principal.title("zam")
    Label(text="").pack()
    Button(text="iniciar sesion", command=login).pack() 
    Label(text="").pack()
    Button(text="cerrar sesion").pack() 
    Label(text="").pack()
    Button(text="Registrarse", command=registro).pack() 
    Label(text="").pack()
...
def registro():
    ...
    Label(ventana_registro, text="Introduzca datos", bg="skyblue").pack()
    ...
    entrada_clave.pack()
    Label(ventana_registro, text="").pack()
    Button(ventana_registro, text="Registrarse", width=10, height=1, bg="PaleVioletRed1" , command = registro_usuario).pack() #BOTÓN "Registrarse"
...
def login():
    ...
    Label(ventana_login, text="").pack()
    Button(ventana_login, text="Acceder", width=10, height=1, bg="PaleVioletRed1", command = verifica_login).pack()
