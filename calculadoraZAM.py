...
class Calculadora:
    ...
    #     ventana.geometry("285x190")
        ...
        self.datos = Entry(ventana, font=("Seven Segment",12), textvariable=self.calculo, justify="right")
        self.datos.grid(columnspan=15, ipadx=32)
        i = 0
        boton0 = Button(ventana, text=' 0 ', fg='black', bg='salmon',
        ...
        for fila in range(2,5):
            for columna in range(0,3):
                i += 1
                bot = Button(ventana, text=' ' + str(i) + ' ', fg='black', bg='salmon',
        ...
        for fil in range(2,6):
            operador = Button(ventana, text=' ' + digitos[fil-2] + ' ', fg='black', bg='salmon',
        ...
        resultado = Button(ventana, text=' = ', fg='black', bg='salmon',
                       command=self.igual, height=2, width=5)
        resultado.grid(row=5, column=2)
        limpiar = Button(ventana, text='borrar', fg='red', bg='salmon',
